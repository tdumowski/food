    ...
    <div class="osahan-account-page-left shadow-sm rounded bg-white h-100">
        ...
        <div class="osahan-user text-center">
            <div class="osahan-user-media">
                <img class="mb-3 rounded-pill shadow-sm mt-1" src="{{ (!empty($profileData->photo)) ? url('upload/user_images/' . $profileData->photo) : 
                    url('upload/no_user.png') }}" alt="gurdeep singh osahan">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('dashboard') }}" role="tab" aria-controls="orders" aria-selected="true">
                <i class="icofont-food-cart"></i>Profile</a>
        </li>
        <li class="nav-item">
