                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="avatar-xl me-3">
                                            <img src="{{ (!empty($profileData->photo)) ? url('upload/client_images/' . $profileData->photo) : url('upload/no_user.png') }}" 
                                                alt="" class="img-fluid rounded-circle d-block" width="110" height="110">
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <div class="mb-3">
                                        <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/' . $profileData->photo) : 
                                            url('upload/no_user.png') }}" alt="" class="rounded-circle p-1 bg-primary" width="110" height="110">
                                    </div>
                                    <div class="mt-4">
