                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="name" type="text" id="example-text-input" value="{{ $coupon->name }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="description" type="text" id="example-text-input" value="{{ $coupon->description }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="discount" type="number" id="example-text-input" value="{{ $coupon->discount }}">
                                    </div>
                                </div>
